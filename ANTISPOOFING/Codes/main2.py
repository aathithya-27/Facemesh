...
confidence = 0.8
maxFaces = 3  # Set maximum number of faces to process per frame
...
while True:
    ...
    face_count = 0  # Counter for faces in the current frame

    for r in results:
        boxes = r.boxes  # Bounding boxes
        for box in boxes:
            if face_count >= maxFaces:
                break  # Stop processing if maxFaces limit is reached
